<template>
  <div>
    ...
    <h1 class="ml-3 my-6 sm:my-8 title"> All users of service <span v-if="purchases"><span v-if="purchases.data[0].user_name">{{purchases.data[0].user_name}}</span></span> </h1>
    ...
    <div class="flex flex-wrap gap-y-4 justify-end items-end py-2 w-full">
...
export default {
  ...
  methods: {
    ...
    getAllUsersOfService() {
      this.errors = null
      this.$store.dispatch("purchases/getAllUsersOfService", {
