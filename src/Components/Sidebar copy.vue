<template>
  <!-- <Navbar :user="user" @toggleSidebar="showSidebar = !showSidebar" /> -->
  <Navbar :user="user" />
    ...
    <div id="main-sidebar" class="h-full px-3 pb-4 overflow-y-auto bg-secondary">
      <ul class="space-y-2 font-medium h-min-3/4 min-h-[60%] pt-6">
        ...
        <!-- new purchase -->
         <li v-if="user.role_id == 1">
          <router-link
            to="/purchase/create" class="-px-4 py-2 item-dropdown-menu"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <router-link
            to="/profile" class="-px-4 py-2 item-dropdown-menu"
          >
        ...
        <!-- service -->
        <li v-if="user.role_id == 1">
          <button type="button" @click="toggleDropdown = !toggleDropdown" class="-px-4 py-2 item-dropdown-menu">
          ...
          <ul v-show="toggleDropdown" id="dropdown-articlee" class="py-2 space-y-2">
            <li>
              <router-link to="/services" class="pl-11 item-dropdown-menu"> Services</router-link>
            </li>
            <li>
              <router-link
                to="/service/create" class="pl-11 item-dropdown-menu"
              >
                New service
              </router-link>
            </li>
        ...
        <!-- users list -->
         <li v-if="user.role_id == 1">
          <router-link
            to="/users" class="-px-4 py-2 item-dropdown-menu"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
